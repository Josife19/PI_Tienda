...
-- Tiempo de generación: 20-04-2026 a las 21:39:02
...
--
-- Base de datos: `trabajo_pi_tienda_cartas`
--
...
--
ALTER TABLE `inscripciones_evento`
  ADD CONSTRAINT `inscripciones_evento_ibfk_1` FOREIGN KEY (`id_cliente`) REFERENCES `clientes` (`id_cliente`),
  ADD CONSTRAINT `inscripciones_evento_ibfk_2` FOREIGN KEY (`id_evento`) REFERENCES `eventos` (`id_evento`);
